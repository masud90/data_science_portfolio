  ...
  html:
    ...
    other-links:
      - text: Portfolio Website
        href: https://masud90.github.io/
        icon: github
        rel: noopener noreferrer
        target: _blank
      - text: Twitter
        href: https://x.com/masudtweets/
        icon: twitter-x
        rel: noopener noreferrer
        target: _blank
...
```{r}
#| fig-cap: "Figure 1: Histogram showing the distribution of miles per gallon (mpg) across the cars."
...
```{r}
#| fig-cap: "Figure 2: Boxplot depicting the variation in miles per gallon (mpg) and cylinders."
...
```{r}
#| fig-cap: "Figure 3: Scatter plot showing the relationship between horsepower and miles per gallon (mpg)."
...
```{r}
#| fig-cap: "Figure 4: Pairwise plot illustrating the relationships between all numeric variables."
...
```{r}
#| fig-cap: "Figure 5: Heatmap showing the Pearson correlation coefficients."
